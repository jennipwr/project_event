...
<div class="card">
  <div class="card-body">
    ...
    <form action="{{ route('panitia.updateEvent', $event['id_event']) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
        ...
        <div class="card-body">
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control @error('syarat_ketentuan') is-invalid @enderror" 
                      ...
                      required>{{ old('syarat_ketentuan', $event['syarat_ketentuan']) }}</textarea>
          ...
          <div class="mb-4">
            <label for="poster" class="form-label fw-bold">
              ...
              @if(!empty($event['poster']))
                <div class="mb-2">
                    <img src="{{ 'http://localhost:3000/' . $event['poster'] }}" alt="Current Poster" class="img-thumbnail" style="max-width: 200px;">
                ...
                <div class="row mb-3">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control border-2 @error('sessions.'.$i.'.nama_sesi') is-invalid @enderror" 
                          name="sessions[{{ $i }}][nama_sesi]" value="{{ $sessions[$i]['nama_sesi'] ?? '' }}" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control border-2 @error('sessions.'.$i.'.narasumber_sesi') is-invalid @enderror" 
                          name="sessions[{{ $i }}][narasumber_sesi]" value="{{ $sessions[$i]['narasumber_sesi'] ?? '' }}" 
                ...
                <div class="row mb-3">
                  <div class="col-md-4">
                    ...
                    <input type="date" class="form-control border-2 @error('sessions.'.$i.'.tanggal_sesi') is-invalid @enderror" 
                      name="sessions[{{ $i }}][tanggal_sesi]" 
                      value="{{ isset($sessions[$i]['tanggal_sesi']) ? date('Y-m-d', strtotime($sessions[$i]['tanggal_sesi'])) : '' }}" required>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="time" class="form-control border-2 @error('sessions.'.$i.'.waktu_sesi') is-invalid @enderror" 
                          name="sessions[{{ $i }}][waktu_sesi]" value="{{ $sessions[$i]['waktu_sesi'] ?? '' }}" required>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="number" class="form-control border-2 @error('sessions.'.$i.'.jumlah_peserta') is-invalid @enderror" 
                          name="sessions[{{ $i }}][jumlah_peserta]" min="1" value="{{ old('sessions.'.$i.'.jumlah_peserta', $sessions[$i]['jumlah_peserta'] ?? '') }}" 
                ...
                <div class="row mb-3">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control border-2 @error('sessions.'.$i.'.lokasi_sesi') is-invalid @enderror" 
                          name="sessions[{{ $i }}][lokasi_sesi]" value="{{ old('sessions.'.$i.'.lokasi_sesi', $sessions[$i]['lokasi_sesi'] ?? '') }}" 
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control border-2 border-success @error('sessions.'.$i.'.biaya_sesi') is-invalid @enderror" 
                            name="sessions[{{ $i }}][biaya_sesi]" min="0" value="{{ old('sessions.'.$i.'.biaya_sesi', $sessions[$i]['biaya_sesi'] ?? '') }}" 
